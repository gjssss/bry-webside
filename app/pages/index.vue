...
<template>
  <div>
    <NavComp />
    <div class="absolute left-0 top-0 z--1 h-screen w-full">
      <div class="bg-image h-full w-full" />
    </div>
    <div class="h-screen w-full from-black/40 bg-gradient-to-r pl-80px pt-80px">
    ...
    <div ref="contentContainer" class="mx-a max-w-1280px px-10 pt-12">
      <div>
